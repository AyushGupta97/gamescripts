...
def entropy(data):
	...
	entropy = 0
	if(positive_ex > 0 and negative_ex > 0):
		entropy = (-1)*(positive_ex/float(total_ex))*(math.log(positive_ex,2)-math.log(total_ex,2))+((-1)*(negative_ex/float(total_ex))*(math.log(negative_ex,2)-math.log(total_ex,2)))
	return entropy
